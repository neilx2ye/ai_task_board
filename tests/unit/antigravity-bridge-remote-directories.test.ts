...
describe("Antigravity Bridge session sync device identity", () => {
  ...
  it("sends flat device_id and device_label fields with the 1.5.0 capability version", async () => {
    ...
    expect(body.bridge_version).toBe("1.5.0-antigravity.1");
    expect(ANTIGRAVITY_BRIDGE_CAPABILITY_VERSION).toBe("1.5.0-antigravity.1");
