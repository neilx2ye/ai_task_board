...
describe("Antigravity Bridge session sync device identity", () => {
  ...
  it("sends flat device_id and device_label fields with the 1.7.1 capability version", async () => {
    ...
    expect(body.bridge_version).toBe("1.7.1-antigravity.2");
    expect(ANTIGRAVITY_BRIDGE_CAPABILITY_VERSION).toBe("1.7.1-antigravity.2");
