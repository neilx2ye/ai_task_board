...
mode pins an `ANTIGRAVITY_WORKING_DIRECTORY` allowlist at install time
instead. The installer writes a `0600` environment file, stages the runtime
under the user's XDG data directory, and starts
