...
```bash
npx --yes ai-task-board-bridge@1.8.5 setup
```
...
npx --yes ai-task-board-bridge@1.8.5 setup kimi
npx --yes ai-task-board-bridge@1.8.5 setup antigravity
npx --yes ai-task-board-bridge@1.8.5 setup claude
npx --yes ai-task-board-bridge@1.8.5 setup both
npx --yes ai-task-board-bridge@1.8.5 setup all
```
...
rerunning `npx --yes ai-task-board-bridge@1.8.5 setup` for the same runtime.
...
Use `npx --yes ai-task-board-bridge@1.8.5 --help` for the complete
...
npx --yes ai-task-board-bridge@1.8.5 run kimi
```
...
npx --yes ai-task-board-bridge@1.8.5 run antigravity
```
...
npx --yes ai-task-board-bridge@1.8.5 run claude
```
