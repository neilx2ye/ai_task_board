...
npx --yes ai-task-board-bridge@1.6.0 run codex
```
...
rerunning `npx --yes ai-task-board-bridge@1.6.0 setup` for the same runtime.
...
Use `npx --yes ai-task-board-bridge@1.6.0 --help` for the complete
