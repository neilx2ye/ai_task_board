...
```bash
npx --yes ai-task-board-bridge@1.7.0 setup
```
...
```bash
npx --yes ai-task-board-bridge@1.7.0 setup codex
npx --yes ai-task-board-bridge@1.7.0 setup kimi
npx --yes ai-task-board-bridge@1.7.0 setup antigravity
npx --yes ai-task-board-bridge@1.7.0 setup claude
npx --yes ai-task-board-bridge@1.7.0 setup both
npx --yes ai-task-board-bridge@1.7.0 setup all
```
...
npx --yes ai-task-board-bridge@1.7.0 run codex
```
...
rerunning `npx --yes ai-task-board-bridge@1.7.0 setup` for the same runtime.
...
Use `npx --yes ai-task-board-bridge@1.7.0 --help` for the complete
...
npx --yes ai-task-board-bridge@1.7.0 run kimi
```
...
npx --yes ai-task-board-bridge@1.7.0 run antigravity
```
